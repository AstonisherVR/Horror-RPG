...
directories = Array[String](["res://General Assets/kenney_input-prompts/Keyboard & Mouse/Default", "res://General Assets/kenney_input-prompts/Generic/Default", "res://General Assets/kenney_input-prompts/Xbox Series/Default", "res://General Assets/kenney_input-prompts/PlayStation Series/Default", "res://General Assets/kenney_input-prompts/Nintendo Switch/Default", "res://General Assets/kenney_input-prompts/Steam Deck/Default"])
filter = "color"
ends_with = ".png"
